    ...
    <div class="row">
        <div class="col-md-3">
            <div class="search-sidebar">
                <h3>Tìm kiếm</h3>
                <form action="<?php echo URLROOT; ?>/store/search" method="GET" class="search-form">
                    <div class="form-group">
                        <input type="text" name="keyword" class="form-control" value="<?php echo $data['keyword']; ?>" placeholder="Nhập từ khóa...">
                    </div>
                    <button type="submit" class="btn btn-primary">Tìm kiếm</button>
                </form>
                
                <div class="categories-sidebar mt-4">
        ...
        <div class="col-md-9">
            <div class="search-results">
                <h1>Kết quả tìm kiếm: "<?php echo $data['keyword']; ?>"</h1>
                
                <?php if(empty($data['products'])): ?>
                    <div class="alert alert-info">
                        Không tìm thấy sản phẩm nào phù hợp với từ khóa "<?php echo $data['keyword']; ?>".
                    </div>
                <?php else: ?>
                    <div class="row">
